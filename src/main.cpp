...
int64 nChainStartTime = 1403006400;
...
const string strMessageMagic = "PoosCoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_PoosCoin_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PoosCoin
    bool fStrictPayToScriptHash = true; // Always active in PoosCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PoosCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "21/6 for PoosCoin Relaunch";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1403006400;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1666666;
        ...
        assert(block.hashMerkleRoot == uint256("0xe7e4369ec32da2e42596e3cb65a6f8a35e8658cdd1b1da9ede287b6587c391b4"));
